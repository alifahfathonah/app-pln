<script>
    var dataTable = '';
    var baseUrl = '<?= base_url('kendaraan') ?>';
    ...
    function format(data) {
        return `<table class="table table-detail">
                    ...
                    <tr>
                        <td>Foto</td>
                        <td>:</td>
                        <td><img src="<?= base_url() ?>assets/upload/${data.foto}" width="50%"></td>
                    </tr>
                </table>`;
    }
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.validasi === false) {
                    validation('#nopol', 'nopol', data);
                    validation('#nama', 'nama', data);
                    validation('#jenis_kendaraan', 'jenis_kendaraan', data);
    ...
    function ubah_data(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#nama').val(data.nama);
                $('#jenis_kendaraan').val(data.id_jenis_kendaraan);
