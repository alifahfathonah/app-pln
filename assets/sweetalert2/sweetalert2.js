...
function swalCustom(icon, title, message) {
  Swal.fire({
    icon: icon,
    title: title,
    text: message,
    showConfirmButton: true,
    confirmButtonText: '<i class="fas fa-check-circle"></i> Oke!',
    // timer: 1500
  })
}

function swalAlert(icon, title, message) {
  Swal.fire({
    icon: icon,
    title: title,
    text: message,
